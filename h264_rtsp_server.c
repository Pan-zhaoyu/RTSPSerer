...
#define H264_FILE_NAME   "live.264"
#define SERVER_PORT      8550
...
int main(int argc, char* argv[])
{
    ...
    if(bindSocketAddr(serverSockfd, ip, SERVER_PORT) < 0)
    {
